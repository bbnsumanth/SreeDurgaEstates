...
public class NavigationAdapter extends RecyclerView.Adapter<NavigationAdapter.ViewHolder> {
     ...
     * @param Profile
     */
    public NavigationAdapter(String Titles[], int Icons[], String Name, String Email, int Profile){ // NavigationAdapter Constructor with titles and icons parameter
        mNavTitles = Titles;
        mIcons = Icons;
        name = Name;
        email = Email;
     ...
     *
     * @param parent
     * @param viewType int to represent which layout to be inflated.
     * @return NavigationAdapter.ViewHolder
     */
    @Override
